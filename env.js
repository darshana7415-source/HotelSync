...
// StaffSync compatibility aliases for separate pages
if (window.STAFFSYNC_ENV) {
  window.SUPABASE_URL = window.STAFFSYNC_ENV.SUPABASE_URL;
  window.SUPABASE_ANON_KEY = window.STAFFSYNC_ENV.SUPABASE_ANON_KEY;
  window.STAFFSYNC_CONFIG = window.STAFFSYNC_ENV;
}
